...
public class AppCronometro implements ActionListener{
    ...
    public AppCronometro() {
        ...
        btnIniciar.setForeground(new Color(0,100,0));
        btnRetroceder.setForeground(new Color(0,0,255));
        btnParar.setForeground(new Color(150,0,0));
        btnReset.setForeground(new Color(100,0,0));
        btnMemoria.setForeground(new Color(155,100,0));
    ...
    public void actionPerformed(ActionEvent a) {
        ...
        if(a.getActionCommand().equals("Iniciar")){
            ...
            forward = true;
            timer = new Timer();
            timer.schedule(new RemindTask(),0, 1*1);
        ...
        if(a.getActionCommand().equals("Reset")){
            ...
            for(int x=00;x<lblMemoria.length;x++){
